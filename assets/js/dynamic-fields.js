...
(function () {
  ...
  function compare(condition, actual) {
    ...
    const normalizedList = expectedList.map(value => value.toLowerCase());
    ...
    if (operator === 'contains') return actualArray ? actualArray.some(value => value.toLowerCase() === normalizedExpected) : normalizedActual.includes(normalizedExpected);
    if (operator === 'in') return normalizedList.includes(normalizedActual);
    if (operator === 'not_in') return !normalizedList.includes(normalizedActual);
