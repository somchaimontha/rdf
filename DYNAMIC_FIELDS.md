...
ตัวสร้างเงื่อนไขแบ่งเป็น 4 ขั้น ได้แก่ เลือกแหล่งข้อมูล เลือกฟิลด์ เลือกวิธีเปรียบเทียบ และเลือกค่า ฟิลด์ที่มีค่ามาตรฐานจะแสดง dropdown หรือ checkbox พร้อมชื่อที่แปลแล้ว ระบบเก็บรหัสจริงให้อัตโนมัติและเปรียบเทียบโดยไม่สนตัวพิมพ์เล็ก–ใหญ่ ส่วนช่องกรอกขั้นสูงจะแสดงเฉพาะฟิลด์ข้อความที่ไม่มีรายการค่ามาตรฐาน

เงื่อนไขรองรับ `equals`, `not_equals`, `contains`, `in`, `not_in`, `is_empty` และ `is_not_empty` โดยเลือกอ้างอิงข้อมูลหลักหรือ `FieldID` ของ custom field หน้า builder จะแสดงสรุปเงื่อนไขเป็นประโยคให้อ่านก่อนบันทึก
